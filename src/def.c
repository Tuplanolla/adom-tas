...
intern const int default_duration_key = KEY_F(2);
intern const int default_unduration_key = MOD_SHIFT + KEY_F(2);
intern const int default_time_key = KEY_F(3);
intern const int default_untime_key = MOD_SHIFT + KEY_F(3);
